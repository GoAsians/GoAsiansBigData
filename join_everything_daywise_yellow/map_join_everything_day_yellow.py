			...
			if (len(words)==33): #Data from weather
				...
				try:
					...
					if (len(year)==2):
						year = "00"+str(year)
					key2 = year+month+day
					value = words[0]+','+words[2]+','+words[3]+','+words[4]+','+words[5]+','+words[6]+','+words[7]+','+words[8]+','+words[9]+','+words[10]+','+words[11]+','+words[12]+','+words[13]+','+words[14]+','+words[15]+','+words[16]+','+words[17]+','+words[18]
